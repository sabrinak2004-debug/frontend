...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="de">
      <body className="bg-[#f7f9fb] min-h-screen">
          ...
          <div className="pt-4 border-t border-gray-200 mt-8">
            {user ? (
              <div className="flex items-center gap-3">
                <div className="p-2 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center shadow-md">
        ...
        <main className="md:ml-72 p-4 md:p-10 min-h-screen bg-[#f7f9fb]">
          {children}
        </main>
      </body>
    </html>
